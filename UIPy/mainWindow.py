...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.update_system_button_2 = QtWidgets.QToolButton(self.gridLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.update_system_button_2.sizePolicy().hasHeightForWidth())
        self.update_system_button_2.setSizePolicy(sizePolicy)
        self.update_system_button_2.setMinimumSize(QtCore.QSize(70, 70))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.update_system_button_2.setFont(font)
        self.update_system_button_2.setStyleSheet("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/resource/update.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.update_system_button_2.setIcon(icon8)
        self.update_system_button_2.setIconSize(QtCore.QSize(60, 60))
        self.update_system_button_2.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.update_system_button_2.setObjectName("update_system_button_2")
        self.gridLayout_2.addWidget(self.update_system_button_2, 4, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.update_system_button_2.setText(_translate("MainWindow", "软件升级"))
