...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/resource/measure.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.send_measure_button.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/resource/setting1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.set_property_button.setIcon(icon1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/resource/zhihui.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.send_file_button.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/resource/gps.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.send_position_button.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/resource/checking1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.system_check_button.setIcon(icon6)
        ...
        self.reset_button.setMinimumSize(QtCore.QSize(100, 100))
        font = QtGui.QFont()
        ...
        self.horizontalLayout_16.addWidget(self.reset_button)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/resource/button_save_juhang.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.property_save_button.setIcon(icon7)
