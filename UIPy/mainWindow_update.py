...
# Form implementation generated from reading ui file 'mainWindow_update.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(840, 0, 151, 41))
        font = QtGui.QFont()
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(830, 50, 171, 501))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/resource/checking1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.system_check_button.setIcon(icon2)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/resource/telephone1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.start_voice_button.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/resource/关机.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.shut_down_button.setIcon(icon6)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/resource/zhihui.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.shut_down_button_2 = QtWidgets.QToolButton(self.gridLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.shut_down_button_2.sizePolicy().hasHeightForWidth())
        self.shut_down_button_2.setSizePolicy(sizePolicy)
        self.shut_down_button_2.setMinimumSize(QtCore.QSize(70, 70))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.shut_down_button_2.setFont(font)
        self.shut_down_button_2.setStyleSheet("")
        self.shut_down_button_2.setIcon(icon6)
        self.shut_down_button_2.setIconSize(QtCore.QSize(60, 60))
        self.shut_down_button_2.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.shut_down_button_2.setObjectName("shut_down_button_2")
        self.gridLayout_2.addWidget(self.shut_down_button_2, 5, 0, 1, 1)
        ...
        self.__width_band_label_2 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.__width_band_label_2.setAutoFillBackground(False)
        self.__width_band_label_2.setObjectName("__width_band_label_2")
        self.horizontalLayout_16.addWidget(self.__width_band_label_2, 0, QtCore.Qt.AlignHCenter)
        self.frequency_point_spinbox = QtWidgets.QSpinBox(self.verticalLayoutWidget)
        self.frequency_point_spinbox.setReadOnly(True)
        self.frequency_point_spinbox.setMaximum(2000)
        self.frequency_point_spinbox.setObjectName("frequency_point_spinbox")
        self.horizontalLayout_16.addWidget(self.frequency_point_spinbox)
        ...
        self.line.setGeometry(QtCore.QRect(720, 130, 21, 261))
        ...
        self.frequency_point_dial = QtWidgets.QDial(self.verticalLayoutWidget_2)
        self.frequency_point_dial.setObjectName("frequency_point_dial")
        self.verticalLayout_2.addWidget(self.frequency_point_dial)
        ...
        self.shut_down_button_2.clicked.connect(MainWindow.update_slot)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.shut_down_button_2.setText(_translate("MainWindow", "更新"))
        ...
        self.work_pattern_combox.setItemText(0, _translate("MainWindow", "低速双工(1.2bps~3840bps)"))
        self.work_pattern_combox.setItemText(1, _translate("MainWindow", "高速双工(38.4kbps~375kbps)"))
        ...
        self.__width_band_label_2.setText(_translate("MainWindow", "频点"))
        self.frequency_point_spinbox.setSuffix(_translate("MainWindow", "MHz"))
